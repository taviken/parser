...
def test_lexer():
    ...
    expected_tokens = [
        ...
        Token(text="module", kind="name", lineno=0, span=(1, 7)),
        ...
        Token(text="{", kind="operator", lineno=0, span=(18, 19)),
        Token(text=" ", kind="whitespace", lineno=0, span=(19, 20)),
        Token(text="\t", kind="whitespace", lineno=1, span=(0, 1)),
        Token(text="unsigned", kind="name", lineno=1, span=(1, 9)),
        Token(text=" ", kind="whitespace", lineno=1, span=(9, 10)),
        Token(text="long", kind="name", lineno=1, span=(10, 14)),
